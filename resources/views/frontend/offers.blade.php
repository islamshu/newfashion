                            ...
                            <div id="slick2">
                                    ...
                                    <div class="product-card style-4">
                                        <div class="product-card-img double-img">
                                            <a href="product-default.html">
                                                <img src="{{asset('front/assets/img/home1/sp-product-img-01.png')}}" alt="" class="img1">
                                                <img src="{{asset('front/assets/img/home1/sp-product-img-05.png')}}" alt="" class="img2">
                                                <div class="batch">
                                                    <span>-15%</span>
                                                </div>
                                            </a>
                                ...
                                <div class="slide-item">
                                    <div class="product-card style-4">
                                        <div class="product-card-img">
                                            <a href="product-default.html">
                                                <img src="{{asset('front/assets/img/home1/sp-product-img-02.png')}}" alt="">
                                                <div class="batch">
                                                    <span>-15%</span>
                                                </div>
                                            </a>
                                ...
                                <div class="slide-item">
                                    <div class="product-card style-4">
                                        <div class="product-card-img">
                                            <a href="product-default.html">
                                                <img src="{{asset('front/assets/img/home1/sp-product-img-03.png')}}" alt="">
                                                <div class="batch">
                                                    <span>-15%</span>
                                                </div>
                                            </a>
                                ...
                                <div class="slide-item">
                                    <div class="product-card style-4">
                                        <div class="product-card-img">
                                            <a href="product-default.html">
                                                <img src="{{asset('front/assets/img/home1/sp-product-img-04.png')}}" alt="">
                                                <div class="batch">
                                                    <span>-15%</span>
                                                </div>
                                            </a>
                                ...
                                <div class="slide-item">
                                    <div class="product-card style-4">
                                        <div class="product-card-img double-img">
                                            <a href="product-default.html">
                                                <img src="{{asset('front/assets/img/home1/sp-product-img-05.png')}}" alt="" class="img1">
                                                <img src="{{asset('front/assets/img/home1/sp-product-img-01.png')}}" alt="" class="img2">
                                                <div class="batch">
                                                    <span>-15%</span>
                                                </div>
                                            </a>
                                ...
                                <div class="slide-item">
                                    <div class="product-card style-4">
                                        <div class="product-card-img">
                                            <a href="product-default.html">
                                                <img src="{{asset('front/assets/img/home1/sp-product-img-06.png')}}" alt="">
                                                <div class="batch">
                                                    <span>-15%</span>
                                                </div>
                                            </a>
                                ...
                                <div class="slide-item">
                                    <div class="product-card style-4">
                                        <div class="product-card-img">
                                            <a href="product-default.html">
                                                <img src="{{asset('front/assets/img/home1/sp-product-img-01.png')}}" alt="">
                                                <div class="batch">
                                                    <span>-15%</span>
                                                </div>
                                            </a>
                                ...
                                <div class="slide-item">
                                    <div class="product-card style-4">
                                        <div class="product-card-img">
                                            <a href="product-default.html">
                                                <img src="{{asset('front/assets/img/home1/sp-product-img-05.png')}}" alt="">
                                                <div class="batch">
                                                    <span>-15%</span>
                                                </div>
                                            </a>
