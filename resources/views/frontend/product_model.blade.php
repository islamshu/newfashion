                                ...
                                <div class="shop-details-img">
                                    <div class="tab-content" id="view-tabContent">
                                        <div class="tab-pane fade show active" id="view-pills-img1" role="tabpanel">
                                            <div class="shop-details-tab-img">
                                                <img src="{{asset('front/assets/img/inner-page/shop-details-tab-img1.png')}}" alt="">
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="view-pills-img2" role="tabpanel"
                                            >
                                            <div class="shop-details-tab-img">
                                                <img src="{{asset('front/assets/img/inner-page/shop-details-tab-img2.png')}}" alt="">
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="view-pills-img3" role="tabpanel">
                                            <div class="shop-details-tab-img">
                                                <img src="{{asset('front/assets/img/inner-page/shop-details-tab-img3.png')}}" alt="">
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="view-pills-img4" role="tabpanel">
                                            <div class="shop-details-tab-img">
                                                <img src="{{asset('front/assets/img/inner-page/shop-details-tab-img4.png')}}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nav nav-pills" id="view-tab" role="tablist" aria-orientation="vertical">
                                        <button class="nav-link active" id="view-pills-img1-tab" data-bs-toggle="pill" data-bs-target="#view-pills-img1" type="button"
                                            ...
                                            <img src="{{asset('front/assets/img/inner-page/shop-details-nav-img1.png')}}" alt="">
                                        </button>
                                        <button class="nav-link" id="view-pills-img2-tab" data-bs-toggle="pill" data-bs-target="#view-pills-img2" type="button"
                                            ...
                                            <img src="{{asset('front/assets/img/inner-page/shop-details-nav-img2.png')}}" alt="">
                                        </button>
                                        <button class="nav-link" id="view-pills-img3-tab" data-bs-toggle="pill"
                                            ...
                                            <img src="{{asset('front/assets/img/inner-page/shop-details-nav-img3.png')}}" alt="">
                                        </button>
                                        <button class="nav-link" id="view-pills-img4-tab" data-bs-toggle="pill"
                                            ...
                                            <img src="{{asset('front/assets/img/inner-page/shop-details-nav-img4.png')}}" alt="">
                                        </button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="shop-details-content">
                                    ...
                                    <div class="payment-method">
                                        ...
                                        <ul class="payment-card-list">
                                            <li><img src="{{asset('front/assets/img/inner-page/payment-img1.svg')}}" alt=""></li>
                                            <li><img src="{{asset('front/assets/img/inner-page/payment-img2.svg')}}" alt=""></li>
                                            <li><img src="{{asset('front/assets/img/inner-page/payment-img3.svg')}}" alt=""></li>
                                            <li><img src="{{asset('front/assets/img/inner-page/payment-img4.svg')}}" alt=""></li>
                                            <li><img src="{{asset('front/assets/img/inner-page/payment-img5.svg')}}" alt=""></li>
                                            <li><img src="{{asset('front/assets/img/inner-page/payment-img6.svg')}}" alt=""></li>
                                            <li><img src="{{asset('front/assets/img/inner-page/payment-img7.svg')}}" alt=""></li>
                                        </ul>
                                    </div>
