            ...
            <div class="main-menu">
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item-has-children position-inherit">
                        ...
                        <div class="mega-menu2" style="background-image: url('{{asset('front/assets/img/home1/megamenu2-face-bg.png')}}');">
                    ...
                    <li class="menu-item-has-children position-inherit">
                        ...
                        <div class="mega-menu2" style="background-image: url('{{asset('front/assets/img/home1/megamenu2-body-bg.png')}}');">
                            <div class="megamenu-wrap">
                                <ul class="menu-row">
                                    <li class="menu-single-item">
                                        <a href="shop-list.html">
                    ...
                    <li class="menu-item-has-children position-inherit">
                        ...
                        <div class="mega-menu2" style="background-image: url('{{asset('front/assets/img/home1/megamenu2-hair-bg.png')}}');">
                            <div class="megamenu-wrap">
                                <ul class="menu-row">
                                    <li class="menu-single-item">
                                        <a href="shop-list.html">
                    ...
                    <li class="menu-item-has-children position-inherit">
                        ...
                        <div class="mega-menu2" style="background-image: url('{{asset('front/assets/img/home1/megamenu2-bg1.png')}}');">
                            <div class="megamenu-wrap">
                                <ul class="menu-row">
                                    <li class="menu-single-item">
                                        <a href="shop-list.html">
                    ...
                    <form class="mobile-menu-form">
                        ...
                        <div class="email pt-20 d-flex align-items-center">
                            ...
                            <div class="email-info">
                                <span>Email Now</span>
                                <h6><a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#294c51484459454c694e44484045074a4644"><span class="__cf_email__" data-cfemail="610419000c110d0421060c00080d4f020e0c">[email&#160;protected]</span></a></h6>
                            </div>
                        </div>
                    </form>
                        ...
                        <div class="cart-body">
                            <ul>
                                <li class="single-item">
                                    <div class="item-area">
                                        <div class="item-img">
                                            <img src="{{asset('front/assets/img/home1/cart-img-1.png')}}" alt="">
                                        </div>
                                ...
                                <li class="single-item">
                                    <div class="item-area">
                                        <div class="item-img">
                                            <img src="{{asset('front/assets/img/home1/cart-img-2.png')}}" alt="">
                                        </div>
                                        <div class="content-and-quantity">
                                            <div class="content">
                                                <div class="price-and-btn d-flex align-items-center justify-content-between">
