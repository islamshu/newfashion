            ...
            <div class="row gy-4">
                    ...
                    <div class="product-card hover-btn">
                        <div class="product-card-img double-img">
                           <a href="product-default.html">
                            <img src="{{asset('front/assets/img/home1/product-img-1.png')}}" alt="" class="img1">
                            <img src="{{asset('front/assets/img/home1/product-img-4.png')}}" alt="" class="img2">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-card hover-btn">
                        <div class="product-card-img double-img">
                           <a href="product-default.html">
                            <img src="{{asset('front/assets/img/home1/product-img-3.png')}}" alt="" class="img1">
                            <img src="{{asset('front/assets/img/home1/product-img-20.png')}}" alt="" class="img2">
                            <div class="batch">
                                <span>-25%</span>
                            </div>
                           </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-card hover-btn">
                        <div class="product-card-img">
                            <a href="product-default.html">
                                <img src="{{asset('front/assets/img/home1/product-img-4.png')}}" alt="">
                                <div class="batch">
                                    <span>-15%</span>
                                </div>
                            </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-card hover-btn">
                        <div class="product-card-img">
                           <a href="product-default.html">
                            <img src="{{asset('front/assets/img/home1/product-img-5.png')}}" alt="">
                            <div class="batch">
                                <span>-15%</span>
                            </div>
                           </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-card hover-btn">
                        <div class="product-card-img double-img">
                           <a href="product-default.html">
                            <img src="{{asset('front/assets/img/home1/product-img-6.png')}}" alt="" class="img1">
                            <img src="{{asset('front/assets/img/home1/product-img-7.png')}}" alt="" class="img2">
                            <div class="batch">
                                <span>-15%</span>
                            </div>
                           </a>
