                ...
                <div class="row g-lg-4 gy-5 justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-lg-end justify-content-md-center">
                        <div class="footer-widget">
                            ...
                            <div class="app-store">
                                <a href="#">
                                    <img src="{{asset('front/assets/img/home1/google-play.png')}}" alt="">
                                </a>
                                <a href="#">
                                    <img src="{{asset('front/assets/img/home1/app-store.png')}}" alt="">
                                </a>
                            </div>
                            <div class="payment-gateway">
                                ...
                                <div class="icons">
                                    ...
                                    <img src="{{asset('front/assets/img/home1/icon/american-express.png')}}" alt="">
