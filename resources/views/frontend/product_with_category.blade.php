<div class="just-for-section mb-110">
        <img src="{{asset('front/assets/img/home1/icon/vector-1.svg')}}" alt="" class="vector1">
        <img src="{{asset('front/assets/img/home1/icon/vector-2.svg')}}" alt="" class="vector2">
        <div class="container">
            ...
            <div class="row gy-4 justify-content-center">
                <div class="col-lg-3">
                    ...
                    <div class="offer-img hover-img">
                        <img src="{{asset('front/assets/img/home1/offer-img.png')}}" alt="">
                            ...
                            <div class="row gy-4">
                                    ...
                                    <div class="product-card style-2 hover-btn">
                                        <div class="product-card-img double-img">
                                           <a href="product-default.html">
                                            <img src="{{asset('front/assets/img/home1/product-img-7.png')}}" alt="" class="img1">
                                            <img src="{{asset('front/assets/img/home1/product-img-22.png')}}" alt="" class="img2">
                                            <div class="batch">
                                                <span>-15%</span>
                                            </div>
                                           </a>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="product-card style-2 hover-btn">
                                        <div class="product-card-img">
                                           <a href="product-default.html">
                                            <img src="{{asset('front/assets/img/home1/product-img-8.png')}}" alt="">
                                            <div class="batch">
                                                <span>-15%</span>
                                            </div>
                                           </a>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="product-card style-2 hover-btn">
                                        <div class="product-card-img double-img">
                                           <a href="product-default.html">
                                            <img src="{{asset('front/assets/img/home1/product-img-9.png')}}" alt="" class="img1">
                                            <img src="{{asset('front/assets/img/home1/product-img-21.png')}}" alt="" class="img2">
                                            <div class="batch">
                                <span>-15%</span>
                            </div>
                                           </a>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="product-card style-2 hover-btn">
                                        <div class="product-card-img">
                                           <a href="product-default.html">
                                            <img src="{{asset('front/assets/img/home1/product-img-10.png')}}" alt="">
                                            <div class="batch">
                                <span>-15%</span>
                            </div>
                                           </a>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="product-card style-2 hover-btn">
                                        <div class="product-card-img double-img">
                                           <a href="product-default.html">
                                            <img src="{{asset('front/assets/img/home1/product-img-11.png')}}" alt="" class="img1">
                                            <img src="{{asset('front/assets/img/home1/product-img-14.png')}}" alt="" class="img2">
                                            <div class="batch">
                                <span>-15%</span>
                            </div>
                                           </a>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="product-card style-2 hover-btn">
                                        <div class="product-card-img">
                                           <a href="product-default.html">
                                            <img src="{{asset('front/assets/img/home1/product-img-12.png')}}" alt="">
                                            <div class="batch">
                                <span>-15%</span>
                            </div>
                                           </a>
