<div class="say-about-section mb-110">
    ...
    <div class="container-fluid p-0">
        <div class="section-title2 style-3">
            <h3>{{ __('هم يقولون عن منتجنا') }}</h3>
            <div class="slider-btn">
                <div class="about-prev-btn" aria-label="{{ __('السابق') }}">
                    <i class="bi bi-arrow-left"></i>
                </div>
                <div class="about-next-btn" aria-label="{{ __('التالي') }}">
                                        ...
                                        <div class="say-about-card-top">
                                            <ul>
                                                @for ($i = 1; $i <= 5; $i++)
                                                    <li>
                                                        <i
                                                            class="bi {{ $i <= $review->stars ? 'bi-star-fill' : 'bi-star' }}"></i>
                                                    </li>
                                                @endfor
                                            </ul>
                                        </div>
