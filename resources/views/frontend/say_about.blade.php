                                        ...
                                        <div class="say-about-card-bottom">
                                            <div class="author-area">
                                                <div class="author-img">
                                                    <img src="{{asset('front/assets/img/home2/testimonial-author-img1.png')}}" alt="">
                                                </div>
                                                <div class="author">
                                                    <h5>Jayden Carter</h5>
                                ...
                                <div class="swiper-slide">
                                    <div class="say-about-card">
                                        ...
                                        <div class="say-about-card-bottom">
                                            <div class="author-area">
                                                <div class="author-img">
                                                    <img src="{{asset('front/assets/img/home2/testimonial-author-img2.png')}}" alt="">
                                                </div>
                                                <div class="author">
                                                    <h5>Colton Roman</h5>
                                ...
                                <div class="swiper-slide">
                                    <div class="say-about-card">
                                        ...
                                        <div class="say-about-card-bottom">
                                            <div class="author-area">
                                                <div class="author-img">
                                                    <img src="{{asset('front/assets/img/home2/testimonial-author-img3.png')}}" alt="">
                                                </div>
                                                <div class="author">
                                                    <h5>Lincoln Miles</h5>
