                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('sliders.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                    ...
                                    <input type="file" required name="image_ar" id="image_ar" class="form-control image" accept="image/*">
                                    @error('image_ar')
                                 ...
                                 <div class="col-md-6 mt-2">
                                    ...
                                    <input type="file" required name="image_he" id="image_ar" class="form-control image" accept="image/*">
                                    @error('image_he')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
