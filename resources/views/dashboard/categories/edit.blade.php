                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" action="{{ route('categories.update', $category->id) }}"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="parent_id" id="parent_id"
                                                                ...
                                                                @foreach ($categories as $cat)
                                                                    {{-- استثناء نفس التصنيف لكي لا يختار نفسه أباً --}}
                                            ...
                                            <!-- قسم اللغة العربية -->
                                            <div class="form-section mb-4">
                                                <h5 class="section-title"><i class="ft-flag"></i> {{ __('اسم التصنيف') }}
                                                </h5>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                required class="form-control" name="name[ar]"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                value="{{ $category->getTranslation('name', 'he') }}"
                                                                required class="form-control" name="name[he]"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="mt-2">
                                                                <img src="{{ $category->image ? asset('storage/' . $category->image) : asset('images/default-image.png') }}"
