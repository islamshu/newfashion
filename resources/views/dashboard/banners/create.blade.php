                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <img id="imagePreview"
                                        ...
                                        style="width: 150px; height: auto; margin-top: 10px; display: {{ isset($banner) && $banner->image ? 'block' : 'none' }};"
                                        alt="معاينة الصورة">
                                    @error('image')
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <textarea name="description[ar]" class="form-control mb-2" placeholder="{{ __('وصف الإعلان بالعربية') }}"
                                                rows="1">{{ old('description.ar', optional($banner)->getTranslation('description', 'ar')) }}</textarea>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="button_text[he]" class="form-control  mb-2"
                                                dir="rtl" placeholder="{{ __('عنوان الزر بالعبرية') }}"
